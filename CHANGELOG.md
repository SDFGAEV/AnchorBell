...
- Preserved maker-only, closed-equity-session, fail-closed, and production-disabled
  boundaries.

This project does not claim Testnet or Production execution evidence until the
corresponding runbook scenarios are completed with separately retained evidence.
